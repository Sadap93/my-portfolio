...
//Import Styles
import { PlanetWrapper, ContainerAboutMe, AboutMeSatellite, AboutMeSectionContainer, AboutMeSectionContainer2 } from '../styles/AboutMeStyles';
//Import FontAwesome
...
const AboutMe = ({ satelliteStatusAboutMe, setSatelliteStatusAboutMe, isPlaying }) => {
    const settings = {
        dots: true,
        fade: true,
        speed: 800,
    ...
    return (
        <>
            <ContainerAboutMe id="about" >
                <PlanetWrapper>
                    <img className={isPlaying ? 'rotate' : 'rotate-pause'} src={Planet} alt="palenet"></img>
                </PlanetWrapper>

                <AboutMeSatellite><span onClick={() => setSatelliteStatusAboutMe(!satelliteStatusAboutMe)}>About Me...<FontAwesomeIcon className="satellite" icon={faSatellite} /></span></AboutMeSatellite>
                <AnimatePresence>
                        ...
                        <Slider className="slider" {...settings}>
                            ...
                            <AnimateSharedLayout>
                                ...
                                >
                                    ...
                                    <h1>Hi, i am<br /><span>Sandor Kovacs</span>,</h1>
                                    <h3>and i'm going to be a frontend developer</h3>
                                    <p>That is the reason why I fight with codes every day at full time since 2020 October and I love it.</p>
                            ...
                            <AnimateSharedLayout >
                                <AboutMeSectionContainer2
                                    ...
                                    <div className="js-wrapper">
                                        <p>JavaScript <FontAwesomeIcon icon={faJsSquare} /></p>
                                        <ul>
                                            <li>Syntax and basic construct</li>
                                            <li>DOM manipulation with vanila JS and jQuery, CSS in JS</li>
                                        </ul>
                                    </div> 
                                    ...
                                    <div className="react-wrapper">
                                        ...
                                        <ul>
                                            ...
                                            <li>Styled-components, basics of Sass, framer-motion and slick</li>
                                        </ul>
                                    </div>
